...
import datart.core.entity.SqlTaskResultExample.Criteria;
import datart.core.entity.SqlTaskResultExample.Criterion;
import datart.core.entity.SqlTaskResultExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SqlTaskResultSqlProvider {
    public String countByExample(SqlTaskResultExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sql_task_result");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(SqlTaskResultExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sql_task_result");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(SqlTaskResult record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sql_task_result");
        ...
        if (record.getColumnCount() != null) {
            sql.VALUES("column_count", "#{columnCount,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(SqlTaskResultExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("id");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SqlTaskResult record = (SqlTaskResult) parameter.get("record");
    ...
    public String updateByPrimaryKeySelective(SqlTaskResult record) {
        SQL sql = new SQL();
        sql.UPDATE("sql_task_result");
        ...
        if (record.getRowCount() != null) {
            sql.SET("`row_count` = #{rowCount,jdbcType=INTEGER}");
        }
        
        if (record.getColumnCount() != null) {
            sql.SET("column_count = #{columnCount,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, SqlTaskResultExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
