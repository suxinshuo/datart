...
import datart.core.entity.StoryboardExample.Criteria;
import datart.core.entity.StoryboardExample.Criterion;
...
public class StoryboardSqlProvider {
    public String countByExample(StoryboardExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("storyboard");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(StoryboardExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("storyboard");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExample(StoryboardExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Storyboard record = (Storyboard) parameter.get("record");
        StoryboardExample example = (StoryboardExample) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, StoryboardExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
